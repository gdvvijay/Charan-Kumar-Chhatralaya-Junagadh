...
export default function AdmissionSection() {
  return (
    <section
      id="admission"
      className="relative mt-30 w-full py-24 lg:py-32 bg-slate-50 dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-100 font-sans overflow-hidden transition-colors duration-500"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20 space-y-5">
          ...
          <h2 className="text-4xl sm:border sm:rounded-full py-5 md:text-5xl font-black tracking-tight text-slate-900 dark:text-white leading-tight">
            પ્રવેશ પ્રક્રિયા અને{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-500">
              ફી માળખું
            </span>
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
            શ્રી કાનજીભાઈ નાગૈયા ચારણ કુમાર છાત્રાલયમાં પ્રવેશ મેળવવા ઈચ્છતા
            વિદ્યાર્થીઓએ નીચે મુજબની પ્રક્રિયા અને ફીની વિગતો ધ્યાનમાં લેવાની
            રહેશે.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-16">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="relative border-l-2 border-orange-200 dark:border-orange-900/50 pl-8 ml-4 md:ml-0 space-y-10">
              ...
              <div className="relative group">
                ...
                <div className="bg-white dark:bg-white/5 p-6 rounded-[2rem] border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-md transition-all group-hover:-translate-y-1">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    છાત્રાલયની કચેરી પરથી પ્રાપ્ત પ્રવેશ ફોર્મ સંપૂર્ણ વિગતો
                    સાથે ભરીને જમા કરાવવું અનિવાર્ય છે.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="bg-white dark:bg-white/5 p-6 rounded-[2rem] border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-md transition-all group-hover:-translate-y-1">
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                    <span className="text-orange-500">૨.</span> કાયદેસરના
                    દસ્તાવેજો
                  </h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-3">
                    ઓળખ અને રહેઠાણના પુરાવા તરીકે નીચે મુજબના જરૂરી દસ્તાવેજોની
                    ઝેરોક્ષ નકલ જોડવી:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300 font-medium">
                      <CheckCircle2 className="w-4 h-4 text-emerald-500" /> આધાર
                      કાર્ડ
                    </li>
                    <li className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300 font-medium">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-slate-800 rounded-[2rem] p-6 hover:border-indigo-500/50 hover:shadow-xl transition-all duration-300 flex flex-col relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <h4 className="text-lg font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">
                    માસિક (Monthly)
                  </h4>
                  ...
                  <div className="mt-auto space-y-3">
                    <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-1">
                        ગીર વિસ્તારના (ST) વિદ્યાર્થીઓ માટે:
                      </p>
              ...
              <div className="md:col-span-2 bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-950 rounded-[2rem] p-1 shadow-2xl relative overflow-hidden transform md:-rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="relative z-10 bg-slate-900/40 backdrop-blur-xl rounded-[1.8rem] p-6 sm:p-8 h-full flex flex-col md:flex-row items-center md:items-center justify-between gap-6 border border-white/10">
                  <div className="w-full md:w-auto">
                    ...
                    <h4 className="text-xl font-bold text-slate-300 uppercase tracking-wider mb-2">
                      વાર્ષિક (Full Year)
                    </h4>
            ...
            <div className="mt-6 bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-900/50 rounded-[1.5rem] p-5 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-sm sm:text-base font-bold text-orange-900 dark:text-orange-300 mb-1">
                  આર્થિક રાહતની નોંધ
                </h4>
                <p className="text-sm text-orange-800 dark:text-orange-400/80 leading-relaxed">
                  ગીર વિસ્તારના અનુસૂચિત જનજાતિ (ST) ના વિદ્યાર્થીઓને શિક્ષણમાં
                  પ્રોત્સાહન આપવા માટે સંસ્થા દ્વારા ફીમાં ખાસ આર્થિક રાહત
                  આપવામાં આવે છે. વધુ માહિતી માટે કાર્યાલયનો સંપર્ક કરવો.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-4 border-t border-slate-200 dark:border-slate-800">
              ...
              <button className="flex-1 px-6 py-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-2xl font-bold text-center transition-all hover:-translate-y-1 hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400 flex items-center justify-center gap-2 group">
            ...
            <div className="space-y-6 text-white">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="block text-base sm:text-lg mb-1">
                      પાત્રતા
                    </strong>
                ...
                {/* Replaced 'Other Branch' with 'Discipline & Rules' */}
                <li className="flex items-start gap-4">
                  <Clock className="w-7 h-7 text-orange-400 shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-lg mb-1">
                      શિસ્ત અને સમયપાલન
                    </strong>
                    <span className="text-slate-300 leading-relaxed block">
                      વિદ્યાર્થીઓએ છાત્રાલયના નીતિ-નિયમો અને સમયપત્રકનું
                      ચુસ્તપણે પાલન કરવાનું રહેશે. છાત્રાલયમાં શિસ્તબદ્ધ વર્તન
                      અનિવાર્ય છે.
                    </span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-slate-300 leading-relaxed block">
                      ઉપર જણાવેલ પ્રક્રિયા મુજબ, ફોર્મ જમા કરાવવા અને એડમિશન
                      કન્ફર્મ કરવા માટે વિદ્યાર્થીએ પોતાના વાલી સાથે જરૂરી
                      દસ્તાવેજો લઈને છાત્રાલયની રૂબરૂ મુલાકાત લેવાની રહેશે.
                    </span>
                  </div>
                </li>
              </ul>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm sm:text-lg font-medium leading-relaxed">
                      આઈશ્રી સોનલ માઁ ચારણ સભા સંચાલિત,
                      <br />
                      શ્રી કાનજીભાઈ નાગૈયા કુમાર છાત્રાલય,
                      <br />
                      બિલખા રોડ, ITI ની નજીક,
                      <br />
                      મેઘાણી નગર,જૂનાગઢ, ગુજરાત - ૩૬૨૦૦૧.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="block text-2xl sm:text-3xl font-black text-white hover:text-orange-400 transition-colors mb-2"
                    >
                      +91 98242 88852
                    </a>
