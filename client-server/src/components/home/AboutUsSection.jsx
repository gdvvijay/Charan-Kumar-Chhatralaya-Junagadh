      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-12 relative">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative border-l-2 border-orange-200 dark:border-orange-900/50 pl-8 ml-4 md:ml-0 space-y-12 mt-32">
              
              <div className="relative">
                <div className="absolute -left-[41px] top-1 bg-orange-500 rounded-full w-5 h-5 ring-4 ring-slate-50 dark:ring-[#0a0a0a]"></div>
                <div className="bg-white dark:bg-slate-900 relative -top-12 max-[900px]:-top-15 max-[500px]:-top-18 max-[350px]:-top-24 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
