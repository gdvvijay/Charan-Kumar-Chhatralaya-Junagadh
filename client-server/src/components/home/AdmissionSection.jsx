            ...
            <div className="space-y-6 text-white">
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="block text-lg mb-1">શિસ્ત અને સમયપાલન</strong>
                    <span className="text-slate-300 leading-relaxed block">
                      વિદ્યાર્થીઓએ છાત્રાલયના નીતિ-નિયમો અને સમયપત્રકનું ચુસ્તપણે પાલન કરવાનું રહેશે. છાત્રાલયમાં શિસ્તબદ્ધ વર્તન અનિવાર્ય છે.
                    </span>
                  </div>
                </li>
