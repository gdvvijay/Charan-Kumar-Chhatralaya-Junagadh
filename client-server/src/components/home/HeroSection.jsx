...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen font-sans overflow-hidden transition-colors duration-500 bg-slate-50 dark:bg-[#0a0a0a] mt-30">
      ...
      <div className="relative  max-w-7xl z-10 container mx-auto px-3 lg:px-6 py-20 min-h-screen flex flex-col justify-center">
